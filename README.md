...
- [MakerWorld](https://makerworld.com/en/@apollo917/upload)
- [Printables](https://www.printables.com/@apollo917_4881357/models)
...
- **Height:** 150mm
- **Width:** depends on the tube length you choose
- ⚠️ **NOTE** ⚠️
    - When marking the holes, keep in mind that each screw hole should be positioned **~39mm behind the front edge of
      the side stand** - this ensures that the shelf will sit exactly where you want it on your desk
    - Keep in mind that some accessories, or certain ways of using them, may require additional vertical space -
